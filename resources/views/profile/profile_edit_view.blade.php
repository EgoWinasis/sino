                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <x-adminlte-card title="Edit Profile" theme="dark" icon="fas fa-lg fa-portrait">
                                ...
                                <x-adminlte-input name="nik" label="Nomor Induk Karyawan" placeholder="Nomor Induk Karyawan"
                                ...
                                @php
                                $options = ['-'=>'-','Marketing' => 'Marketing', 'Teknologi Informasi' => 'Teknologi Informasi'];
                                if (!empty(old('bagian'))) {
                                $selected = [old('bagian')];
                                }else{
                                ...
                                @endphp
                                <x-adminlte-select name="bagian" label="Divisi">
